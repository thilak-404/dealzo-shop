      ...
      <header className="sticky top-0 z-50 glass border-b border-slate-200/50 shadow-sm transition-all duration-300">
        <div className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="bg-slate-900 border border-slate-800 text-white w-11 h-11 md:w-auto md:px-5 rounded-2xl flex items-center justify-center gap-3 text-xs font-black uppercase tracking-widest hover:bg-black hover:shadow-2xl hover:shadow-blue-500/20 transition-all group">
              <Sparkles size={18} className="text-yellow-400 group-hover:rotate-12 transition-transform" />
              <span className="hidden md:block">Daily Rewards</span>
            </button>
          </div>
        </div>
      </header>
          ...
          <div className="space-y-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 bg-white p-1 rounded-2xl border border-slate-100 shadow-sm self-start">
                <button className="px-4 py-2 text-[10px] font-black uppercase tracking-widest bg-slate-50 text-slate-900 rounded-xl">Hot</button>
                <button className="px-4 py-2 text-[10px] font-black uppercase tracking-widest text-slate-400">New</button>
              </div>
            </div>
